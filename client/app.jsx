...
class ReviewsModule extends React.Component {
  ...
  handleSearchChange(e) {
    ...
    if (!this.props.searchBool && e.target[0].value.length > 0 && !k) {
      ...
      const newList = this.props.reviews[0].filter((data) =>
        data.body.toLowerCase().includes(e.target[0].value.toLowerCase())
      );
      ...
      return (
        <Body>
          ...
          <Search
            ...
            handleBackToOriginalList={this.handleBackToOriginalList.bind(this)}
          />

          <Reviews
            ref={this.reviews}
            searchBool={this.props.searchBool}
            data={this.props.reviews[0]}
            staticData={this.props.reviews[1]}
          />
        </Body>
      );
    }
...
export default connect(mapStateToProps, { fetchReviews, changeSearchBool })(
  ReviewsModule
);
